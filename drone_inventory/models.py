...
#import for flask marshmellow
from flask_marshmallow import Marshmallow


#create an instance of SQLAlchemy
db = SQLAlchemy()
login_manager = LoginManager() #<-- parenthesis!
ma = Marshmallow()
...
class Drone(db.Model):
    ...
    def __init__ (self, name, decription, price, camera_quality, flight_time, max_speed, dimensions, weight, cost_of_production, series, random_joke, user_token, id =''):
        self.id = self.set_id()
        self.name = name
